...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="./Data/Age", help="Path to the data directory containing AgeDB (default: ./Data)")
    parser.add_argument("--output_dir", type=str, default="./Rupture_Comportement/Age_Estimation/data", help="Path to the output directory for processed CSVs (default: ./Rupture_Comportement/Age_Estimation/data)")
